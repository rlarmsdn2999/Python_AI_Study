...
data_path=glob('C:/Users/User/Desktop/rlarmsdn/python/Project 2023.8.28/RockPaperScissors AI Game/dataset/testing/*.jpg') # Path for test images
...
for test_no in range(3):       # Image No. for test
